...
public class crudUser extends VerticalLayout{
	...
	public crudUser(UserRepository repoUser) {
		...
		dataProvider.addFilter(
		        user -> StringUtils.containsIgnoreCase(user.getNombre(),NombreField.getValue())));
		...
		//Filtro Apellidos
				...
				ApellidosField.addValueChangeListener(event -> 
				dataProvider.addFilter(
				        user -> StringUtils.containsIgnoreCase(user.getApellidos(),ApellidosField.getValue())));
				...
				dataProvider.addFilter(
				        user -> StringUtils.containsIgnoreCase(user.getTlf(),TlfField.getValue())));
				...
				DNIField.addValueChangeListener(event -> 
				dataProvider.addFilter(
				        user -> StringUtils.containsIgnoreCase(user.getDni(),DNIField.getValue())));
				...
				DireccionField.addValueChangeListener(event -> 
				dataProvider.addFilter(
				        user -> StringUtils.containsIgnoreCase(user.getDireccion(),DireccionField.getValue())));
				...
				dataProvider.addFilter(
				        user -> StringUtils.containsIgnoreCase(user.getUsername(),UsernameField.getValue())));
